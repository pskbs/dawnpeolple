...
export const BUNGAE_COPY = {
  ...
  allTitle: '모든 소모임',
  titleLabel: '제목',
  titlePlaceholder: '예: 새벽 퇴근 후 같이 운동해요',
  bodyLabel: '소개',
  bodyPlaceholder:
    '예: 새벽에 퇴근하고 혼자 심심한데, 같이 모여서 운동도 하고 취미도 나누고 밥도 먹어요.',
  contentGuide: '운동·취미·식사·영화 같은 건전한 활동으로 소개해 주세요. 이성 만남·소개팅 목적의 모임은 제한될 수 있어요.',
...
export const NOTIFICATION_COPY = {
  ...
  tabNotifications: '알림',
  empty: '아직 받은 알림이 없어요.',
  emptyHint: '내 글에 댓글이 달리거나, 메시지가 오거나, 내 소모임에 누가 참가하거나 댓글을 남기면 여기에 알려드려요.',
  markAllRead: '모두 읽음',
  settingsTitle: '알림 설정',
  ...
  pushFailed: '푸시 동의를 받지 못했어요. 잠시 후 다시 시도해 주세요.',
  types: {
    comment: { label: '댓글', desc: '내 수다글에 누가 댓글을 달았을 때' },
    comment_reply: { label: '답글', desc: '내가 단 댓글에 누가 답글을 남겼을 때' },
    bungae_comment: { label: '소모임 댓글', desc: '내 소모임에 댓글이 달리거나, 소모임에서 내 댓글에 답글이 달렸을 때' },
