...
// 2026-09-22: 부천 고정 바인딩을 해제하고 전국 오픈으로 확장(docs/decisions.md 참고).
// 시/군/구는 광역 대표 행정구역까지만 다뤄요(다구 도시의 구 단위는 생략). 읍/면/동은 목록이 너무 커서
// 소모임 개설 화면에서 직접 입력받아요.
...
// 소모임 개설 화면의 "탭 한 번으로 채우는 칩" — 부천 위주로 시작한 서비스라 부천만 우선 제공해요.
export const BUCHEON_SIDO: Sido = '경기'
export const BUCHEON_SIGUNGU = '부천시'
